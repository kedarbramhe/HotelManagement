 ...
 * @author vedisoft
 */
public class BookingsAddMorGuests extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (id != null) {
                ...
                out.println("<form action=\"AddNonPrimaryGuests\">");
                out.println("<b>Add More Guests:</b><br>");
                out.println("<input type=\"hidden\" name=\"bookingid\" value=\"" + bookingid + "\">");
                out.println("<b>Enter guest Name:</b>");
                out.println("<input type=\"text\" name=\"guestname\" ></br>");
                out.println("<b>Enter guest age:</b>");
                out.println("<input type=\"text\" name=\"age\"> </br>");
                out.println("  <b>Gender  : </b> <input type=\"radio\" group=\"gender\" value=\"male\" checked=\"true\" name=\"gender\" />Male ");
                ...
                out.println("<input type=\"hidden\" name=\"primary\" value=\"No\">");
