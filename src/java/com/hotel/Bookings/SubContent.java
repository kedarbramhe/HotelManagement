...
public class SubContent extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Rooms> ar = bd.findRoomsEmpty(id);
            out.println("<b>Rooms Available</b>");
            out.println("<select multiple=\"true\" name=\"roomno\">");
            for (Rooms c : ar) {
                out.println("<option name=\"" + c.getRoomNo() + "\" value=\"" + c.getRoomNo() + "\">" + c.getRoomNo() + "</option>");
            }
