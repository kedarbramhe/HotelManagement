 ...
 * @author vedisoft
 */
public class BookingConfimation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<h1>Your Booking Has Been Confirmed.</h1>");
            out.println("<form name=\"thisform\"  action=\"BookingsAddMorGuests?guestid=" + request.getParameter("guestid") + "\"   onSubmit=\"return validate(this);\">");
            out.println("<input type=\"submit\" value=\"Add other Guests\">");
            out.println("</form>");
            out.println("</div></div>");
