 ...
 * @author vedisoft
 */
public class RoomCategoriesAdd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println(" <form method=\"post\" action=\"RoomCategoryForm?opn=add\"  id=\"contactform\" onSubmit=\"return validate(this);\">");
            out.println("  <b>Category Name : </b> <input type=\"text\" name=\"rcategoryname\" /> <br/>");
            out.println("  <b>Category Details  : </b> <input type=\"text\" name=\"rcategorydetails\"/><br/> ");
