 ...
 * @author vedisoft
 */
public class RatesAdd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println(" <form method=\"post\" action=\"RatesForm?opn=add\"  onSubmit=\"return validate(this);\">");
            out.println(" <b>From Date :</b> <input type=\"text\" name=\"fromdate\"  id=\"popup_container1\"/> <br/>");
            out.println(" <b>To Date  : </b> <input type=\"text\" name=\"todate\"  id=\"popup_container2\"/>    <br/> ");
            ...
            out.println("   <b>Tax : </b> <input type=\"text\" name=\"tax\" /> <br/>");
            out.println("   <b>Rate : </b> <input type=\"text\" name=\"rate\" /> <br/>");
